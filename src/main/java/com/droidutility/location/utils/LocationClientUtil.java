package com.droidutility.location.utils;
...
public class LocationClientUtil {
    ...
    public void initAndConnect(boolean iConnectBool, LocationRequest iLocRequest) {
        ...
        mLocationClient = new GoogleApiClient.Builder(DroidApplication.getsContext())
     ...
     * @throws com.droidutility.location.utils.LocationClientUtil.AlreadyConnectedException if on call mLocationClient is already connected
     */
    ...
    private void sendLocalLocationBroadcast(Location iLocation) {
        LocalBroadcastManager broadCastManager = LocalBroadcastManager.getInstance(DroidApplication.getsContext());
